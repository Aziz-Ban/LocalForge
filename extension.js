...
function activate(context) {
    vscode.window.showInformationMessage('LocalForge is ready to help! 🚀');
    ...
    context.subscriptions.push(
        vscode.commands.registerCommand('smart-copilot.startServer', async (port, modelId) => {
            try {
                ...
                vscode.window.showInformationMessage(`LocalForge Server started on port ${actualPort}`, 'Show API Usage')
                    .then(selection => {
